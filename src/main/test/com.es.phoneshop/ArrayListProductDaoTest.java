...
public class ArrayListProductDaoTest {
    ...
    @Test
    public void testFindProductsEmptyList() {
        productDao.clearAll();
    ...
    public void testFindProductsOnlyBadData() {
        productDao.clearAll();
        int badDataAmount = 5;
        for(int i = 0;i < 5;i++) {
    ...
    public void testFindProductsOnlyGoodData() {
        productDao.clearAll();
    ...
    public void testFindProductsBothDataType() {
        productDao.clearAll();
    ...
    @Test
    public void testGetProductPresentId() throws ProductNotFoundException {
        productDao.clearAll();
    ...
    public void testGetProductAbsentId() throws ProductNotFoundException {
        productDao.clearAll();
    ...
    @Test(expected = ProductNotFoundException.class)
    public void testRemoveExisted() throws ProductNotFoundException {
        productDao.clearAll();
        int indices[] = {6,7,8,9};
        for(int i : indices) {
            productDao.save(productArray[i]);
    ...
    @Test(expected = ProductNotFoundException.class)
    public void testRemoveNotExisted() throws ProductNotFoundException {
        productDao.clearAll();
        int indices[] = {1,4,5,9};
        for(int i : indices) {
            productDao.save(productArray[i]);
